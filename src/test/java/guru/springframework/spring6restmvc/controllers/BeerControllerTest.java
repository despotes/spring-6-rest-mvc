...
class BeerControllerTest {
    ...
    void testUpdateBeerValidation() throws Exception {
        BeerDTO beerToUpdate = beerServiceImpl.listBeers(null, null).get(1);
    ...
    void testCreatedNewBeer() throws Exception {
        ...
        given(beerService.saveBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.listBeers(null, null).get(1));
